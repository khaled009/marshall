...
@section('title')  {{$platform->name}} @endsection
@section('header')
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td> الصورة</td>
                            <td><img src="{{asset($platform->image)}}" width="200px"></td>
                        </tr>


                        <tr>
                            <td>الفيديو التوضيحي</td>
                            <td>
...
{{--
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered  display  table-hover dt-responsive" width="100%"
                        ...
                        <tbody>
                        @foreach($platform->children as $child)
                            <tr>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered  display  table-hover dt-responsive" width="100%"
                        ...
                        <tbody>
                        @foreach($platform->behaviors as $behavior)
                            <tr>
                                <td class="text-center">{!!$loop->iteration!!}</td>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered  display  table-hover dt-responsive" width="100%"
                        ...
                        <tbody>
                        @foreach($platform->rewards as $award)
                            <tr>
                                <td class="text-center">{!!$loop->iteration!!}</td>
